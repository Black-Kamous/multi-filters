...
@dispatcher_version = dso_local global [2 x i32]* null, section "xdp_metadata", align 8, !dbg !21
...
define dso_local i32 @prog0(%struct.xdp_md* readnone %0) local_unnamed_addr #0 !dbg !52 {
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %3), !dbg !69
  call void @llvm.dbg.declare(metadata i32* %2, metadata !66, metadata !DIExpression()), !dbg !70
  store volatile i32 31, i32* %2, align 4, !dbg !70, !tbaa !71
  %4 = icmp eq %struct.xdp_md* %0, null, !dbg !75
  br i1 %4, label %7, label %5, !dbg !77

5:                                                ; preds = %1
  %6 = load volatile i32, i32* %2, align 4, !dbg !78, !tbaa !71
  br label %7, !dbg !79

7:                                                ; preds = %1, %5
  %8 = phi i32 [ %6, %5 ], [ 0, %1 ], !dbg !68
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %3), !dbg !80
  ret i32 %8, !dbg !80
}
...
define dso_local i32 @prog1(%struct.xdp_md* readnone %0) local_unnamed_addr #0 !dbg !81 {
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %3), !dbg !86
  call void @llvm.dbg.declare(metadata i32* %2, metadata !84, metadata !DIExpression()), !dbg !87
  store volatile i32 31, i32* %2, align 4, !dbg !87, !tbaa !71
  %4 = icmp eq %struct.xdp_md* %0, null, !dbg !88
  br i1 %4, label %7, label %5, !dbg !90

5:                                                ; preds = %1
  %6 = load volatile i32, i32* %2, align 4, !dbg !91, !tbaa !71
  br label %7, !dbg !92

7:                                                ; preds = %1, %5
  %8 = phi i32 [ %6, %5 ], [ 0, %1 ], !dbg !85
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %3), !dbg !93
  ret i32 %8, !dbg !93
}
...
define dso_local i32 @prog2(%struct.xdp_md* readnone %0) local_unnamed_addr #0 !dbg !94 {
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %3), !dbg !99
  call void @llvm.dbg.declare(metadata i32* %2, metadata !97, metadata !DIExpression()), !dbg !100
  store volatile i32 31, i32* %2, align 4, !dbg !100, !tbaa !71
  %4 = icmp eq %struct.xdp_md* %0, null, !dbg !101
  br i1 %4, label %7, label %5, !dbg !103

5:                                                ; preds = %1
  %6 = load volatile i32, i32* %2, align 4, !dbg !104, !tbaa !71
  br label %7, !dbg !105

7:                                                ; preds = %1, %5
  %8 = phi i32 [ %6, %5 ], [ 0, %1 ], !dbg !98
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %3), !dbg !106
  ret i32 %8, !dbg !106
}
...
define dso_local i32 @prog3(%struct.xdp_md* readnone %0) local_unnamed_addr #0 !dbg !107 {
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %3), !dbg !112
  call void @llvm.dbg.declare(metadata i32* %2, metadata !110, metadata !DIExpression()), !dbg !113
  store volatile i32 31, i32* %2, align 4, !dbg !113, !tbaa !71
  %4 = icmp eq %struct.xdp_md* %0, null, !dbg !114
  br i1 %4, label %7, label %5, !dbg !116

5:                                                ; preds = %1
  %6 = load volatile i32, i32* %2, align 4, !dbg !117, !tbaa !71
  br label %7, !dbg !118

7:                                                ; preds = %1, %5
  %8 = phi i32 [ %6, %5 ], [ 0, %1 ], !dbg !111
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %3), !dbg !119
  ret i32 %8, !dbg !119
}
...
define dso_local i32 @prog4(%struct.xdp_md* readnone %0) local_unnamed_addr #0 !dbg !120 {
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %3), !dbg !125
  call void @llvm.dbg.declare(metadata i32* %2, metadata !123, metadata !DIExpression()), !dbg !126
  store volatile i32 31, i32* %2, align 4, !dbg !126, !tbaa !71
  %4 = icmp eq %struct.xdp_md* %0, null, !dbg !127
  br i1 %4, label %7, label %5, !dbg !129

5:                                                ; preds = %1
  %6 = load volatile i32, i32* %2, align 4, !dbg !130, !tbaa !71
  br label %7, !dbg !131

7:                                                ; preds = %1, %5
  %8 = phi i32 [ %6, %5 ], [ 0, %1 ], !dbg !124
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %3), !dbg !132
  ret i32 %8, !dbg !132
}
...
define dso_local i32 @prog5(%struct.xdp_md* readnone %0) local_unnamed_addr #0 !dbg !133 {
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %3), !dbg !138
  call void @llvm.dbg.declare(metadata i32* %2, metadata !136, metadata !DIExpression()), !dbg !139
  store volatile i32 31, i32* %2, align 4, !dbg !139, !tbaa !71
  %4 = icmp eq %struct.xdp_md* %0, null, !dbg !140
  br i1 %4, label %7, label %5, !dbg !142

5:                                                ; preds = %1
  %6 = load volatile i32, i32* %2, align 4, !dbg !143, !tbaa !71
  br label %7, !dbg !144

7:                                                ; preds = %1, %5
  %8 = phi i32 [ %6, %5 ], [ 0, %1 ], !dbg !137
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %3), !dbg !145
  ret i32 %8, !dbg !145
}
...
define dso_local i32 @prog6(%struct.xdp_md* readnone %0) local_unnamed_addr #0 !dbg !146 {
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %3), !dbg !151
  call void @llvm.dbg.declare(metadata i32* %2, metadata !149, metadata !DIExpression()), !dbg !152
  store volatile i32 31, i32* %2, align 4, !dbg !152, !tbaa !71
  %4 = icmp eq %struct.xdp_md* %0, null, !dbg !153
  br i1 %4, label %7, label %5, !dbg !155

5:                                                ; preds = %1
  %6 = load volatile i32, i32* %2, align 4, !dbg !156, !tbaa !71
  br label %7, !dbg !157

7:                                                ; preds = %1, %5
  %8 = phi i32 [ %6, %5 ], [ 0, %1 ], !dbg !150
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %3), !dbg !158
  ret i32 %8, !dbg !158
}
...
define dso_local i32 @prog7(%struct.xdp_md* readnone %0) local_unnamed_addr #0 !dbg !159 {
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %3), !dbg !164
  call void @llvm.dbg.declare(metadata i32* %2, metadata !162, metadata !DIExpression()), !dbg !165
  store volatile i32 31, i32* %2, align 4, !dbg !165, !tbaa !71
  %4 = icmp eq %struct.xdp_md* %0, null, !dbg !166
  br i1 %4, label %7, label %5, !dbg !168

5:                                                ; preds = %1
  %6 = load volatile i32, i32* %2, align 4, !dbg !169, !tbaa !71
  br label %7, !dbg !170

7:                                                ; preds = %1, %5
  %8 = phi i32 [ %6, %5 ], [ 0, %1 ], !dbg !163
...
define dso_local i32 @prog8(%struct.xdp_md* readnone %0) local_unnamed_addr #0 !dbg !172 {
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %3), !dbg !177
  call void @llvm.dbg.declare(metadata i32* %2, metadata !175, metadata !DIExpression()), !dbg !178
  store volatile i32 31, i32* %2, align 4, !dbg !178, !tbaa !71
  %4 = icmp eq %struct.xdp_md* %0, null, !dbg !179
  br i1 %4, label %7, label %5, !dbg !181

5:                                                ; preds = %1
  %6 = load volatile i32, i32* %2, align 4, !dbg !182, !tbaa !71
  br label %7, !dbg !183

7:                                                ; preds = %1, %5
  %8 = phi i32 [ %6, %5 ], [ 0, %1 ], !dbg !176
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %3), !dbg !184
  ret i32 %8, !dbg !184
}
...
define dso_local i32 @prog9(%struct.xdp_md* readnone %0) local_unnamed_addr #0 !dbg !185 {
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %3), !dbg !190
  call void @llvm.dbg.declare(metadata i32* %2, metadata !188, metadata !DIExpression()), !dbg !191
  store volatile i32 31, i32* %2, align 4, !dbg !191, !tbaa !71
  %4 = icmp eq %struct.xdp_md* %0, null, !dbg !192
  br i1 %4, label %7, label %5, !dbg !194

5:                                                ; preds = %1
  %6 = load volatile i32, i32* %2, align 4, !dbg !195, !tbaa !71
  br label %7, !dbg !196

7:                                                ; preds = %1, %5
  %8 = phi i32 [ %6, %5 ], [ 0, %1 ], !dbg !189
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %3), !dbg !197
  ret i32 %8, !dbg !197
}
...
define dso_local i32 @compat_test(%struct.xdp_md* readnone %0) local_unnamed_addr #0 !dbg !198 {
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %3), !dbg !203
  call void @llvm.dbg.declare(metadata i32* %2, metadata !201, metadata !DIExpression()), !dbg !204
  store volatile i32 31, i32* %2, align 4, !dbg !204, !tbaa !71
  %4 = icmp eq %struct.xdp_md* %0, null, !dbg !205
  br i1 %4, label %7, label %5, !dbg !207

5:                                                ; preds = %1
  %6 = load volatile i32, i32* %2, align 4, !dbg !208, !tbaa !71
  br label %7, !dbg !209

7:                                                ; preds = %1, %5
  %8 = phi i32 [ %6, %5 ], [ 0, %1 ], !dbg !202
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %3), !dbg !210
  ret i32 %8, !dbg !210
}
...
define dso_local i32 @xdp_pass(%struct.xdp_md* nocapture readnone %0) #4 section "xdp" !dbg !317 {
  call void @llvm.dbg.value(metadata %struct.xdp_md* undef, metadata !319, metadata !DIExpression()), !dbg !320
  ret i32 2, !dbg !321
}
...
attributes #0 = { nofree noinline nounwind "frame-pointer"="all" "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" }
attributes #1 = { mustprogress nofree nosync nounwind readnone speculatable willreturn }
attributes #2 = { argmemonly mustprogress nofree nosync nounwind willreturn }
attributes #3 = { nofree nounwind "frame-pointer"="all" "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" }
