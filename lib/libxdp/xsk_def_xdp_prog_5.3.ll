...
@xsk_prog_version = dso_local global [1 x i32]* null, section "xdp_metadata", align 8, !dbg !54
...
define dso_local i32 @xsk_def_prog(%struct.xdp_md* nocapture noundef readonly %0) #0 section "xdp" !dbg !81 {
  %2 = alloca i32, align 4
  call void @llvm.dbg.value(metadata %struct.xdp_md* %0, metadata !94, metadata !DIExpression()), !dbg !96
  %3 = bitcast i32* %2 to i8*, !dbg !97
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %3) #3, !dbg !97
  %4 = getelementptr inbounds %struct.xdp_md, %struct.xdp_md* %0, i64 0, i32 4, !dbg !98
  %5 = load i32, i32* %4, align 4, !dbg !98, !tbaa !99
  call void @llvm.dbg.value(metadata i32 %5, metadata !95, metadata !DIExpression()), !dbg !96
  store i32 %5, i32* %2, align 4, !dbg !104, !tbaa !105
  %6 = load volatile i32, i32* @refcnt, align 4, !dbg !106, !tbaa !105
  %7 = icmp eq i32 %6, 0, !dbg !106
  br i1 %7, label %15, label %8, !dbg !108

8:                                                ; preds = %1
  call void @llvm.dbg.value(metadata i32* %2, metadata !95, metadata !DIExpression(DW_OP_deref)), !dbg !96
  %9 = call i8* inttoptr (i64 1 to i8* (i8*, i8*)*)(i8* noundef bitcast (%struct.anon* @xsks_map to i8*), i8* noundef nonnull %3) #3, !dbg !109
  %10 = icmp eq i8* %9, null, !dbg !109
  br i1 %10, label %15, label %11, !dbg !111

11:                                               ; preds = %8
  %12 = load i32, i32* %2, align 4, !dbg !112, !tbaa !105
  call void @llvm.dbg.value(metadata i32 %12, metadata !95, metadata !DIExpression()), !dbg !96
  %13 = call i64 inttoptr (i64 51 to i64 (i8*, i32, i64)*)(i8* noundef bitcast (%struct.anon* @xsks_map to i8*), i32 noundef %12, i64 noundef 0) #3, !dbg !113
  %14 = trunc i64 %13 to i32, !dbg !113
  br label %15, !dbg !114

15:                                               ; preds = %8, %1, %11
  %16 = phi i32 [ %14, %11 ], [ 2, %1 ], [ 2, %8 ], !dbg !96
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %3) #3, !dbg !115
  ret i32 %16, !dbg !115
}
...
!1 = distinct !DIGlobalVariable(name: "refcnt", scope: !2, file: !3, line: 27, type: !75, isLocal: false, isDefinition: true)
...
!3 = !DIFile(filename: "xsk_def_xdp_prog_5.3.c", directory: "/root/multi-filters/lib/libxdp", checksumkind: CSK_MD5, checksum: "bae3de4712c516b7b8ed19a2257b01b6")
!4 = !{!5}
...
!57 = distinct !DIGlobalVariable(name: "bpf_map_lookup_elem", scope: !2, file: !58, line: 55, type: !59, isLocal: true, isDefinition: true)
...
!66 = distinct !DIGlobalVariable(name: "bpf_redirect_map", scope: !2, file: !58, line: 1309, type: !67, isLocal: true, isDefinition: true)
...
!73 = !DIDerivedType(tag: DW_TAG_typedef, name: "__u64", file: !72, line: 31, baseType: !74)
!74 = !DIBasicType(name: "unsigned long long", size: 64, encoding: DW_ATE_unsigned)
!75 = !DIDerivedType(tag: DW_TAG_volatile_type, baseType: !28)
...
!81 = distinct !DISubprogram(name: "xsk_def_prog", scope: !3, file: !3, line: 31, type: !82, scopeLine: 32, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !93)
!82 = !DISubroutineType(types: !83)
!83 = !{!28, !84}
!84 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !85, size: 64)
!85 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "xdp_md", file: !6, line: 5944, size: 192, elements: !86)
!86 = !{!87, !88, !89, !90, !91, !92}
!87 = !DIDerivedType(tag: DW_TAG_member, name: "data", scope: !85, file: !6, line: 5945, baseType: !71, size: 32)
!88 = !DIDerivedType(tag: DW_TAG_member, name: "data_end", scope: !85, file: !6, line: 5946, baseType: !71, size: 32, offset: 32)
!89 = !DIDerivedType(tag: DW_TAG_member, name: "data_meta", scope: !85, file: !6, line: 5947, baseType: !71, size: 32, offset: 64)
!90 = !DIDerivedType(tag: DW_TAG_member, name: "ingress_ifindex", scope: !85, file: !6, line: 5949, baseType: !71, size: 32, offset: 96)
!91 = !DIDerivedType(tag: DW_TAG_member, name: "rx_queue_index", scope: !85, file: !6, line: 5950, baseType: !71, size: 32, offset: 128)
!92 = !DIDerivedType(tag: DW_TAG_member, name: "egress_ifindex", scope: !85, file: !6, line: 5952, baseType: !71, size: 32, offset: 160)
!93 = !{!94, !95}
!94 = !DILocalVariable(name: "ctx", arg: 1, scope: !81, file: !3, line: 31, type: !84)
!95 = !DILocalVariable(name: "index", scope: !81, file: !3, line: 33, type: !28)
!96 = !DILocation(line: 0, scope: !81)
!97 = !DILocation(line: 33, column: 2, scope: !81)
!98 = !DILocation(line: 33, column: 19, scope: !81)
!99 = !{!100, !101, i64 16}
!100 = !{!"xdp_md", !101, i64 0, !101, i64 4, !101, i64 8, !101, i64 12, !101, i64 16, !101, i64 20}
!101 = !{!"int", !102, i64 0}
!102 = !{!"omnipotent char", !103, i64 0}
!103 = !{!"Simple C/C++ TBAA"}
!104 = !DILocation(line: 33, column: 6, scope: !81)
!105 = !{!101, !101, i64 0}
!106 = !DILocation(line: 36, column: 7, scope: !107)
!107 = distinct !DILexicalBlock(scope: !81, file: !3, line: 36, column: 6)
!108 = !DILocation(line: 36, column: 6, scope: !81)
!109 = !DILocation(line: 42, column: 6, scope: !110)
!110 = distinct !DILexicalBlock(scope: !81, file: !3, line: 42, column: 6)
!111 = !DILocation(line: 42, column: 6, scope: !81)
...
!115 = !DILocation(line: 46, column: 1, scope: !81)
